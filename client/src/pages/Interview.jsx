    ...
    <div className="min-h-[calc(100vh-5rem)] text-gray-900 flex flex-col items-center justify-center px-6 py-12 overflow-x-hidden bg-transparent">
      ...
      <div className="max-w-5xl w-full text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto text-left">
          ...
          {/* Real Interview Mode */}
          <motion.div
            className="group relative p-5 md:p-6 rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between cursor-pointer"
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ delay: 0.3 }}
            whileHover={{ y: -6, borderColor: '#d1d5db' }}
            onClick={() => navigate("/interview-entry")}
          >
            <div>
              <div className="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-gray-100 text-gray-800 font-bold text-sm group-hover:bg-gray-200 transition-colors">
              Start Practice
          ...
          {/* AI Interview Mode */}
          <motion.div
            className="group relative p-5 md:p-6 rounded-2xl bg-white border-2 border-blue-500 shadow-lg hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 flex flex-col justify-between cursor-pointer"
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            {/* Recommended Badge */}
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-[10px] font-bold uppercase tracking-wider rounded-full shadow-md z-10">
              Most Popular
            </div>

            <div>
              <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-blue-600 text-white font-bold text-sm group-hover:bg-blue-700 transition-colors">
              Start AI Interview
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </div>
          </motion.div>
