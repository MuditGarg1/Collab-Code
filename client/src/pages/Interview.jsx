...
export default function Interview() {
  ...
  return (
    <div className="min-h-screen text-gray-900 flex flex-col items-center justify-center px-6 py-24 bg-transparent">
      ...
      <div className="max-w-6xl w-full text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto text-left">
          ...
          {/* Real Interview Mode */}
          <motion.div
            className="group relative p-8 md:p-10 rounded-[2rem] bg-white border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between cursor-pointer"
          ...
          >
            <div>
              <div className="w-16 h-16 rounded-2xl bg-gray-100 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-gray-100 text-gray-800 font-bold text-lg group-hover:bg-gray-200 transition-colors">
              Start Practice
          ...
          {/* AI Interview Mode */}
          <motion.div
            className="group relative p-8 md:p-10 rounded-[2rem] bg-white border-2 border-blue-500 shadow-lg hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 flex flex-col justify-between cursor-pointer"
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            {/* Recommended Badge */}
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-5 py-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-bold uppercase tracking-wider rounded-full shadow-md z-10">
              Most Popular
            </div>
            ...
            <div className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-blue-600 text-white font-bold text-lg group-hover:bg-blue-700 transition-colors">
              Start AI Interview
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </div>
          </motion.div>
