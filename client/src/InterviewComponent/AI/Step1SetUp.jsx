...
function Step1SetUp({ onStart }) {
    ...
    const handleUploadResume = async () => {
        ...
        try {
            const result = await axios.post(ServerUrl + "/api/ai-interview/resume", formdata, { withCredentials: true })
    ...
    const handleStart = async () => {
        setLoading(true)
        try {
           const result = await axios.post(ServerUrl + "/api/ai-interview/generate-questions" , {role, experience, mode , resumeText, projects, skills } , {withCredentials:true}) 
           console.log(result.data)
           if(userData){
        ...
        <motion.div
            ...
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                ...
                <motion.div
                    ...
                    className='relative bg-linear-to-br from-indigo-50 to-indigo-100 p-12 flex flex-col justify-center'>
                ...
                <motion.div
                    ...
                    <div className='space-y-6'>
                            ...
                            <motion.div
                                ...
                                {resumeFile && (
                                    <motion.button
                                        ...
                                        className='mt-4 bg-gray-50 text-gray-900 px-5 py-2 rounded-lg hover:bg-gray-100 transition'>
                        ...
                        onClick={handleStart}
                            ...
                            whileHover={{ scale: 1.03 }}
                            whileTap={{ scale: 0.95 }}
                            className='w-full disabled:bg-gray-600 bg-indigo-600 hover:bg-indigo-700 text-gray-900 py-3 rounded-full text-lg font-semibold transition duration-300 shadow-md'>
