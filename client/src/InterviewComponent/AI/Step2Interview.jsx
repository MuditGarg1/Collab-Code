...
function Step2Interview({ interviewData, onFinish }) {
  ...
  const submitAnswer = async () => {
    ...
    try {
      const result = await axios.post(ServerUrl + "/api/ai-interview/submit-answer", {
        interviewId,
...
setIsSubmitting(false)
  ...
  const finishInterview = async () => {
    ...
    setIsMicOn(false)
    try {
      const result = await axios.post(ServerUrl+ "/api/ai-interview/finish" , { interviewId} , {withCredentials:true})
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-indigo-50 via-white to-blue-100 flex items-center justify-center p-4 sm:p-6'>
          ...
          <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5'>
            ...
            <div className='grid grid-cols-2 gap-6 text-center'>
              <div>
                ...
                <span className='text-xs text-gray-600'>Current Questions</span>
              </div>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
         ...
         {!feedback ? ( <div className='flex items-center gap-4 mt-6'>
            <motion.button
              onClick={toggleMic}
              whileTap={{ scale: 0.9 }}
              className='w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full bg-transparent text-gray-900 shadow-lg'>
            ...
            disabled={isSubmitting}
              whileTap={{ scale: 0.95 }}
              className='flex-1 bg-linear-to-r from-indigo-600 to-blue-500 text-gray-900 py-3 sm:py-4 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold disabled:bg-gray-500'>
            ...
            className='mt-6 bg-indigo-50 border border-indigo-200 p-5 rounded-2xl shadow-sm'>
              ...
              onClick={handleNext}
               ...
               className='w-full bg-linear-to-r from-indigo-600 to-blue-500 text-gray-900 py-3 rounded-xl shadow-md hover:opacity-90 transition flex items-center justify-center gap-1'>
